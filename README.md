...
[`videos`](/videos) | _(not really code)_ select related videos; **all** product families
...
[`apps/gmail/`](/apps/gmail) | Query for chatty Gmail threads (Node.js & Python) | [Gmail API developer intro](http://bit.ly/4ljSH2W)
...
[`gemini/gem25/`](/gemini/gem25) | Gemini 2.5 API samples (Node.js & Python) | [Gemini 2.5 API Missing Manual](http://bit.ly/4kFkmLm)
&nbsp; | &nbsp; | &nbsp;
